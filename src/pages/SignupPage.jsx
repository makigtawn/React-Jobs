...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registration succeeded: token is already stored in localStorage
      // by registerUser(). Update success state then navigate directly to
      // the app — no need to re-enter credentials on the login page.
