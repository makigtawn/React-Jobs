    ...
    <div className="bg-surface/40 p-5 sm:p-6 md:p-8 lg:p-10 dark:bg-slate-900/60 rounded-xl shadow-md border border-neutral-200/20 dark:border-slate-800">
      ...
      <div className="mb-4 sm:mb-6 lg:mb-8">
        ...
        <Button
          ...
          className="text-black dark:text-surfacetext-xs bg-green-800/10 hover:bg-green-800/20 rounded-md transition-colors"
          style={{ padding: "4px 8px" }}>
          {showFullDescription ? "less" : "more"}
        </Button>
      </div>

      <h3 className="text-xl font-bold text-black dark:text-surfacemb-4 sm:mb-5 lg:mb-6">
        {job.salary} / year
      </h3>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <Link
          to={`/jobs/${job.id}`}
          className="w-full sm:w-auto md:w-44 lg:w-48 h-[44px] md:h-[42px] lg:h-[46px] flex items-center justify-center bg-green-900/20 dark:text-surfacehover:bg-green-800/30 text-black px-6 rounded-lg text-center text-sm md:text-base font-semibold transition-all">
          Read more
        </Link>
      </div>
    </div>
