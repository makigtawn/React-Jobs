...
const ExperienceSection = () => {
  return (
    <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="pointer-events-none absolute right-0 bottom-0 h-48 w-48 rounded-full bg-accent/20 blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          <div className="relative rounded-[2rem] overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.2)]">
            ...
            <div className="absolute left-6 right-6 bottom-6 rounded-[1.5rem] border border-surface/10 bg-surface/10 p-6 backdrop-blur-xl text-white">
              <p className="text-xs uppercase tracking-[0.3em] text-surface/70">
                Strata Gallery
              </p>
              ...
              <div className="mt-4 flex gap-4 border-t border-surface/10 pt-4">
                <div className="text-center">
                  <p className="text-lg font-bold text-white">2.5k+</p>
                  <p className="text-[10px] uppercase tracking-widest text-surface/50">
                    Trusted teams
                  </p>
                </div>
          ...
          <div className="rounded-[2rem] border border-surface/10 bg-[#0d1f25] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.28)] text-white">
            <div className="max-w-xl">
              <h2 className=" text-[#21b8b2] mt-5 text-4xl font-black tracking-tight sm:text-5xl">
                Built for speed and precision
              </h2>

              <p className="mt-5 text-base leading-8 text-surface/70 sm:text-lg">
              ...
              <div className="mt-7 flex flex-col gap-3">
                {features.map((f) => (
                  <div
                    key={f.title}
                    className="flex items-start gap-4 border-l-[3px] border-[#21b8b2] rounded-r-xl bg-surface/5 p-3">
                    <div>
                      <p className="text-sm font-semibold text-white">
                        {f.title}
                      </p>
                      <p className="mt-0.5 text-xs leading-5 text-surface/55">
                        {f.desc}
                      </p>
                    </div>
                  </div>
